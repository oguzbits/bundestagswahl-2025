    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col font-sans antialiased">
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="text-xl font-bold tracking-tight text-slate-900">Bundestagswahl 2025</h1>
          </div>
        </div>
      </header>
          ...
          {isLoading && (
            <div className="flex flex-col items-center justify-center py-20 space-y-4">
              ...
              <p className="text-slate-600 font-medium">
                Wahldaten werden verarbeitet und Ergebnisse geladen...
              </p>
            </div>
          )}
              ...
              {selectedGebiet1 || selectedGebiet2 ? (
                  ...
                  {selectedGebiet1 && !selectedGebiet2 ? (
                    ...
                    <div className="space-y-6 max-w-4xl mx-auto">
                      <MetadataHeader
                        ...
                        parentName={
                          selectedGebiet1.typ === 'Wahlkreis' &&
                          selectedGebiet1.uebergeordnetesGebietId &&
                          data
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-6">
                          <MetadataHeader
                            ...
                            parentName={
                              selectedGebiet2.typ === 'Wahlkreis' &&
                              selectedGebiet2.uebergeordnetesGebietId &&
                              data
                          ...
                          fallback={(error) => (
                            <div className="bg-slate-50 border border-slate-200 p-6 rounded-2xl text-center">
                              <h4 className="text-sm font-bold text-slate-800">
                                Das Vergleichsdiagramm konnte nicht geladen werden
                              </h4>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-slate-200 max-w-2xl mx-auto py-16 px-8 text-center flex flex-col items-center">
                  ...
                  <p className="text-sm text-slate-500 mt-2.5 max-w-md leading-relaxed">
                    Wählen Sie oben über das Suchfeld einen Wahlkreis, ein Bundesland oder das
                    gesamte Bundesgebiet aus, um die Wahlbeteiligung und die Zweitstimmenverteilung
                    anzuzeigen.
                  </p>
                </div>
              )}
      ...
      <footer className="py-4 bg-slate-100/50 text-xs text-muted-foreground border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-slate-500">
          © 2025 Bundestagswahl. Alle Rechte vorbehalten. | Datenquelle:
          Bundeswahlleiter-Ergebnisdateien
        </div>
      </footer>
    </div>
  );
